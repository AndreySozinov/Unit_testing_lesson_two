...
*/
    ...
    void priceCartIsCorrectCalculated() {
        ...
        assertThat(cart.getTotalPrice()).isEqualTo(170+30);
    }
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        assertThat(cart.getTotalPrice()).isEqualTo(170*2+15);
    }
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        assertThat(cart.getTotalPrice()).isEqualTo(170*2+15-170);
    }

    /**
     * 2.4. Разработайте модульный тест для проверки, что при добавлении определенного количества
     * товара в корзину,
    ...
    void quantityProductsStoreChanging() {
        ...
        assertEquals(quantityBefore-times, quantityAfter);
    }
    ...
    void deletedProductIsReturnedToShop() {
        ...
        assertThat(shop.productsShop().get(0).getQuantity()).isEqualTo(10-5+2);
    }
    ...
    void incorrectProductSelectionCausesException(int i) {
        assertThrows(RuntimeException.class, () -> cart.addProductToCartByID(i), "Не найден продукт с id: " + i);
     ...
     * <br><b>Ожидаемый результат:</b> Исключение типа NoSuchFieldError и сообщение
    ...
    void incorrectProductRemoveCausesException() {
        cart.addProductToCartByID(1);
        cart.removeProductByID(1);
        assertThrows(RuntimeException.class, () -> cart.removeProductByID(1), "В корзине не найден продукт с id: 1");
    }
    ...
    @Disabled
    void advancedPriceCartIsCorrectCalculated() {
        cart.addProductToCartByID(1);
        cart.addProductToCartByID(6);
